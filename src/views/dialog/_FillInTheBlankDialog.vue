  ...
  methods: {
    ...
    preCreateQuestion() {
      ...
      if (this.editQuestionId == '') {
        ...
        this.pageData_edit({...obj,order:this.orders,titleContent:'',editorContent:[],strLength:0,selectStr:null,segmentedArr:[],operating:[],tinymceEditorH:[],})
      }
      this.subTopic_already_add(this.childGroups)
