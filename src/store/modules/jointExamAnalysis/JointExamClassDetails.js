...
const actions = {
  ...
  GetStuResults ({ commit }, padata) {
    ...
    return new Promise((resolve, reject) => {
      const { tid, tsid, cid, asid, scids, pageIndex, pageSize, url } = padata
      JointExamClassDetails({ tid, tsid, cid, scids, asid, pageIndex, pageSize, url }).then(res => {
