import {
  GetClassTotalScoreLineStuDetails
...
const actions = {
  ...
  GetStuResults ({ commit }, padata) {
    ...
    return new Promise((resolve, reject) => {
      const { tid, cid, lineName, type, pageIndex, pageSize, url } = padata
      GetClassTotalScoreLineStuDetails({ tid, cid, lineName, type, pageIndex, pageSize, url }).then(res => {
