...
const actions = {
  ...
  GetStuResults ({ commit }, padata) {
    ...
    return new Promise((resolve, reject) => {
      const { tid,tsid,cids,type,tqid,scoreOrOptions,pageIndex,pageSize, url } = padata
      staticAnalysisDetail({ tid,tsid,cids,type,tqid,scoreOrOptions,pageIndex,pageSize, url }).then(res => {
